...
case class AppealAfterPaymentPlanSetupAudit(amountTobePaidinPence: String, chargeReference: String, userWentToSetUpTTP : String)(implicit request: UserRequest[_]) extends JsonAuditModel with JsonUtils {
