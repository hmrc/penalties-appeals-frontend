...
case class PenaltyAppealPaidInFullModel(auditTypeName: String, amountTobePaidinPence: String, chargeReference: String, userWentToPayNow : String, canUserPay : String)(implicit request: UserRequest[_]) extends JsonAuditModel with JsonUtils {
