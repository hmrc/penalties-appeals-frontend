...
import messages.WhenDidTechnologyIssuesBeginMessages._
...
class WhenDidTechnologyIssuesBeginPageSpec extends SpecBase with ViewBehaviours {
  "WhenDidTechnologyIssuesBeginPage" should {
