...
class AppealByLetterKickOutControllerSpec extends SpecBase {
  val page: AppealByLetterKickOutPage = injector.instanceOf[AppealByLetterKickOutPage]
  ...
  val controller = new AppealByLetterKickOutController(page)(
    mcc, appConfig, authPredicate,dataRequiredAction, dataRetrievalAction, ec)

  "AppealByLetterKickOut" should {
    "onPageLoad" should {
