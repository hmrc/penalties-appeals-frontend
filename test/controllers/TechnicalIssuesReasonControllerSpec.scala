...
class TechnicalIssuesReasonControllerSpec extends SpecBase {
  val whenDidTechnologyIssuesBeginPage: WhenDidTechnologyIssuesBeginPage = injector.instanceOf[WhenDidTechnologyIssuesBeginPage]
  ...
  class Setup(authResult: Future[~[Option[AffinityGroup], Enrolments]]) {
    ...
    val controller = new TechnicalIssuesReasonController(whenDidTechnologyIssuesBeginPage, mainNavigator)(authPredicate, dataRequiredAction, appConfig, mcc)
  ...
  "onSubmitForWhenTechnologyIssuesBegan" should {
    "the user is authorised" must {
      //TODO: implement when 'When did technology issues end' page is implemented
