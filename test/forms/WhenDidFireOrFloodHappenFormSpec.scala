  ...
  "WhenDidFireOrFloodHappenedForm" should {
    ...
    "not bind" when {
      "the date is in the future" in {
        ...
        result.errors.head shouldBe FormError("date.day", "fireOrFloodReason.error.notInFuture", Seq("day", "month", "year"))
      }
      ...
      "the date has no day" in {
        ...
        result.errors.size shouldBe 1
        result.errors.head shouldBe FormError("date.day", "fireOrFloodReason.error.required", Seq("day"))
      }
      ...
      "the date has no month" in {
        ...
        result.errors.size shouldBe 1
        result.errors.head shouldBe FormError("date.month", "fireOrFloodReason.error.required", Seq("month"))
      }
      ...
      "the date has no year" in {
        ...
        result.errors.size shouldBe 1
        result.errors.head shouldBe FormError("date.year", "fireOrFloodReason.error.required", Seq("year"))
      }
      ...
      "the date has a day but no month and year" in {
        ...
        result.errors.size shouldBe 1
        result.errors.head shouldBe FormError("date.month", "fireOrFloodReason.error.required.two", Seq("month", "year"))
      }
      ...
      "the date has a month but no day and year" in {
        ...
        result.errors.size shouldBe 1
        result.errors.head shouldBe FormError("date.day", "fireOrFloodReason.error.required.two", Seq("day", "year"))
      }
      ...
      "the date has a year but no day and month" in {
        ...
        result.errors.size shouldBe 1
        result.errors.head shouldBe FormError("date.day", "fireOrFloodReason.error.required.two", Seq("day", "month"))
      }
      ...
      "the date has no values" in {
        ...
        result.errors.size shouldBe 1
        result.errors.head shouldBe FormError("date.day", "fireOrFloodReason.error.required.all", Seq("day", "month", "year"))
      }
    }
  }
