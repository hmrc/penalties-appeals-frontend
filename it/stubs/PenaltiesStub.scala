...
//  private val submitAppealUri = (isLPP: Boolean, penaltyId: String, correlationId: String) =>
//    s"/penalties/appeals/submit-appeal?enrolmentKey=HMRC-MTD-VAT~VRN~123456789&isLPP=$isLPP&penaltyId=$penaltyId&correlationId=$correlationId"
  ...
  ("enrolmentKey" -> containing("HMRC-MTD-VAT~VRN~123456789")),
  ("isLPP" -> containing(isLPP.toString)),
  ("penaltyId" -> containing(penaltyId)),
